...
const GenerateResume = () => {
  ...
  const handleGenerate = async () => {
    try {
      ...
      // Define and normalize resumeData
      const resumeData = {
        ...responseData,  // ← not responseData.data
        personalInformation: {
          fullName: responseData.personalInformation.fullName || "",
          email: responseData.personalInformation.email || "",
          phoneNumber: responseData.personalInformation.phoneNumber || "",
          location: responseData.personalInformation.location || "",
          linkedin: responseData.personalInformation.linkedin || "",
          gitHub: responseData.personalInformation.gitHub || "",
          portfolio: responseData.personalInformation.portfolio || "",
        },
      ...
      // Set form and preview data
      reset(resumeData);      // Populate form fields
      setData(resumeData);    // Update resume preview
